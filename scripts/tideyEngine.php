 ...
 */
function getForecastDay1($city){
    //$forecast = array();
    $is_conn = isConnected();  //Check the connection to the API
    $response = fetchResponse($city);
    ...
    $percipProb = $response['DailyForecasts'][0]['Day']['PrecipitationProbability'];
...
function getForecastDay2($city){
    ...
    $percipProb = $response['DailyForecasts'][1]['Day']['PrecipitationProbability'];
